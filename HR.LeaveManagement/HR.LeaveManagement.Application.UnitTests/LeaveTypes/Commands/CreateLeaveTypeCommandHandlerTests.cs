...
public class CreateLeaveTypeCommandHandlerTests
{
    ...
    {
        var result = await _handler.Handle(new CreateLeaveTypeCommand() {LeaveType = _leaveTypeDto}, CancellationToken.None);
    ...
    public async Task InValid_LeaveType_Added()
    {
        ...
        var result = await _handler.Handle(new CreateLeaveTypeCommand() { LeaveType = _leaveTypeDto },
